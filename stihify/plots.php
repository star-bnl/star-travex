...
<tr>
   <td><?php print $gP->img("deact_$det/sti_hit_any_node/hDiffProjToFitPositionWRTHit", 800); ?>

   <td><?php print $gP->img("deact_$det/sti_hit_any_node/hDiffProjToFitError", 800); ?>

<tr>
   <td><?php print $gP->img("deact_$det/sti_hit_any_node/hCountCandidateHits", 800); ?>

   <td><?php print $gP->img("deact_$det/sti_hit_any_node/hChi2CandidateHits", 800); ?>

<tr>
	<td>&nbsp;

   <td><?php print $gP->img("deact_$det/sti_hit_any_node/hPullCandidateHits2D", 800); ?>

<tr>
   <td><?php print $gP->img("deact_$det/sti_hit_any_node/hActiveLayerCounts", 800); ?>
   <div class="thumbcaption">
   Total number of track nodes. All sectors included
   </div>

   <td><?php print $gP->img("deact_$det/sti_hit_accepted/hActiveLayerCounts", 800); ?>
   <div class="thumbcaption">
   Number of track nodes with an accepted candidate hit. All sectors included
   </div>

<tr>
   <td><?php print $gP->img("deact_$det/sti_hit_ratio/hActiveLayerCounts_pxy", 800); ?>
   <div class="thumbcaption">
   Single hit efficiency in local detector coordinates (y and z). All sectors included
   </div>

   <td><?php print $gP->img("deact_$det/sti_hit_ratio/hActiveLayerCounts_pxy_pfx", 800); ?>
   <div class="thumbcaption">
