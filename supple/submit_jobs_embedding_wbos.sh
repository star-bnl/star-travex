...
JOB_BFC_OPTIONS_3="pp2013a mtd btof fmsDat fgt fgtPoint $JOB_BFC_OPTIONS_VERTEX BEmcChkStat Corr4 OSpaceZ2 OGridLeak3D -hitfilt -evout IdTruth TpxClu -hitfilt Embedding TpcMixer McAna -in NoInput useInTracker emcSim EEfs"
